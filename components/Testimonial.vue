		...
		<div class="max-w-2xl mx-auto lg:max-w-none">
			...
			>
				...
				>
					...
					>
						<p class="text-lg text-gray-600">
							Das individuelle Training mit Marco finde ich
							klasse. Er passt sich dabei immer mir an, da
							ich bislang nicht gerade der sportlichste Typ
							war und eine Arm-OP hinter mir habe.
						</p>
				...
				>
					...
					>
						<p class="text-lg text-gray-600">
							Nach jetzt etwas mehr als 2 Monaten können wir
